...
<!-- Header and Nav -->
  ...
  <div class="row">
    <div class="twelve columns">
      <h1><img src="http://placehold.it/1000x100&text=UkraynaİzmirKonsolosluğu" /></h1>
    </div>
   <div class="row">
    <div class="nine columns">
      <ul class="link-list right">
        <li><a href="#" class="button">AnaSayfa</a></li>
        <li><a href="#"	class="button">Hizmetlerimiz</a></li>
        <li><a href="#" class="button">Konsolosluk</a></li>
        <li><a href="#" class="button">İletişim</a></li>
        <li><a href="#" class="button">Eğitim</a></li>
      </ul>
    </div>
  </div>
