...
return array(
	...
	'subjects' => array(
        'title' => 'Subjects',
        'single' => 'subject',
        'model' => 'AdminModels\\Subject', //In this case I'm just using the un-namespaced "Hat" class/model.
    ),
	'pages' => array(
        'title' => 'Pages',
        'single' => 'page',
        'model' => 'AdminModels\\Pages', //In this case I'm just using the un-namespaced "Hat" class/model.
    ),
	'news' => array(
        'title' => 'News',
        'single' => 'subject',
        'model' => 'AdminModels\\News', //In this case I'm just using the un-namespaced "Hat" class/model.
    ),
